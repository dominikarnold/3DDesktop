/**
 * Created by framue on 11.09.17.
 */
var index, vertex, norm, uv;

class ObjLoader{


    static toMesh(meshName,elmID,flipYUV){
        var d = ObjLoader.parseFromDom(elmID,flipYUV);

       // return index,vertex,norm,uv;
    ...
    static parseObjText(text,flipYUV){
        ...
        while(posB > posA){
            ...
            switch(line.charAt(0)){
                //......................................................
                // Cache Vertex Data for Index processing
                // Sample Data (x,y,z)
            ...
            //parse the next line of the obj data
            posA = posB+1;
            posB = text.indexOf("\n",posA);
        }
